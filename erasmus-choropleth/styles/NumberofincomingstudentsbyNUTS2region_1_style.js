...
var style_NumberofincomingstudentsbyNUTS2region_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Students");
    ...
    if (value >= 0.000000 && value <= 1.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.000000 && value <= 32.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 32.333333 && value <= 204.000000) {
            style = [ new ol.style.Style({
